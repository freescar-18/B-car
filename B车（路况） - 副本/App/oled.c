...
const byte F14x16[] =
{
0x00,0x20,0x20,0x28,0xA8,0x68,0x24,0x28,0xFE,0x24,0x24,0x2C,0x30,0x00,0x00,0x40  ,
 0x7F,0x40,0x3F,0x22,0x22,0x10,0x01,0x0E,0x30,0x60,0x70,0x00  ,/*"武",0*/
/* (14 X 16 , 宋体 )*/

 0x00,0x20,0xC4,0xC8,0x20,0x08,0xF8,0x08,0x08,0x88,0x78,0x00,0x00,0x00,0x00,0x00  ,
 0x7E,0x41,0x40,0x40,0x20,0x1B,0x0C,0x13,0x20,0x60,0x40,0x00  ,/*"汉",1*/
/* (14 X 16 , 宋体 )*/

 0x00,0x88,0x88,0xF8,0x88,0x88,0xFC,0x24,0x24,0xFC,0x24,0xFC,0x04,0x00,0x00,0x30  ,
 0x10,0x0F,0x08,0x48,0x49,0x49,0x49,0x7F,0x49,0x49,0x68,0x00  ,/*"理",2*/
/* (14 X 16 , 宋体 )*/

 0x00,0x00,0x08,0x08,0x08,0x08,0xF8,0x08,0x08,0x08,0x08,0x0C,0x08,0x00,0x00,0x00  ,
 0x20,0x20,0x20,0x20,0x3F,0x20,0x20,0x20,0x20,0x20,0x20,0x00  ,/*"工",3*/
/* (14 X 16 , 宋体 )*/

 0x00,0x20,0x20,0x20,0x20,0x20,0xFE,0xA2,0x20,0x20,0x20,0x20,0x20,0x00,0x00,0x80  ,
 0x40,0x20,0x10,0x0C,0x03,0x03,0x04,0x08,0x30,0x60,0x40,0x00  ,/*"大",4*/
/* (14 X 16 , 宋体 )*/

 0x00,0xC0,0x20,0xA4,0xB8,0xA0,0xA4,0xA8,0xB0,0xA8,0x26,0x60,0x20,0x00,0x00,0x00  ,
 0x08,0x08,0x08,0x48,0x48,0x3E,0x09,0x08,0x08,0x04,0x04,0x00  ,/*"学",5*/
/* (14 X 16 , 宋体 )*/

 0x00,0x60,0x20,0xFC,0x82,0x80,0x40,0xFE,0x20,0x10,0x08,0x0C,0xE0,0x00,0x00,0x08  ,
 0x08,0x0B,0x08,0x08,0x7E,0x09,0x09,0x09,0x09,0x09,0x05,0x00  ,/*"华",6*/
/* (14 X 16 , 宋体 )*/

 0x00,0x00,0x04,0xFC,0xAC,0xAC,0xAC,0xAC,0xAC,0xAC,0xFC,0x02,0x00,0x00,0x00,0x20  ,
 0x50,0x49,0x45,0x4B,0x35,0x15,0x2D,0x47,0x41,0x40,0x40,0x00  ,/*"夏",7*/
/* (14 X 16 , 宋体 )*/

 0x00,0xC0,0x20,0xA4,0xB8,0xA0,0xA4,0xA8,0xB0,0xA8,0x26,0x60,0x20,0x00,0x00,0x00  ,
 0x08,0x08,0x08,0x48,0x48,0x3E,0x09,0x08,0x08,0x04,0x04,0x00  ,/*"学",8*/
/* (14 X 16 , 宋体 )*/

 0x00,0xF8,0x04,0xF4,0x0C,0x10,0x08,0x48,0x4E,0x48,0x28,0x18,0x08,0x00,0x00,0xFF  ,
 0x00,0x00,0x0F,0x41,0x31,0x0F,0x01,0x7F,0x41,0x41,0x70,0x00  ,/*"院",9*/
/* (14 X 16 , 宋体 )*/

 0x00,0x60,0x20,0xFC,0x82,0x80,0x40,0xFE,0x20,0x10,0x08,0x0C,0xE0,0x00,0x00,0x08  ,
 0x08,0x0B,0x08,0x08,0x7E,0x09,0x09,0x09,0x09,0x09,0x05,0x00  ,/*"华",10*/
/* (14 X 16 , 宋体 )*/

 0x00,0xFC,0x88,0xF8,0x04,0x44,0x3C,0xE4,0x3C,0xC4,0x3C,0x24,0x7C,0x00,0x00,0x1F  ,
 0x08,0x07,0x04,0x04,0x7F,0x55,0x55,0x7F,0x55,0x75,0x41,0x00  ,/*"曜",11*/
/* (14 X 16 , 宋体 )*/

 0x00,0x00,0x20,0x20,0x20,0x22,0x2C,0xA0,0x60,0x30,0x00,0x00,0x00,0x00,0x00,0x20  ,
 0x10,0x18,0x24,0x22,0x41,0x40,0x40,0x40,0x40,0x40,0x40,0x00  ,/*"之",12*/
/* (14 X 16 , 宋体 )*/

 0x00,0x00,0xFC,0x44,0xBC,0x04,0x00,0x00,0xFE,0xC0,0x00,0x00,0x00,0x00,0x00,0x00  ,
 0x3F,0x08,0x59,0x2E,0x10,0x0E,0x01,0x03,0x0C,0x30,0x00,0x00  ,/*"队",13*/
/* (14 X 16 , 宋体 )*/

 0x00,0x10,0x90,0x12,0x1C,0xD0,0x30,0x10,0x00,0xF0,0x00,0x00,0xFE,0x00,0x40,0x20  ,
 0x10,0x09,0x06,0x05,0x18,0x00,0x00,0x0F,0x00,0x40,0x3F,0x00  ,/*"刘",14*/
/* (14 X 16 , 宋体 )*/

 0x00,0x10,0x12,0xDC,0xB0,0x40,0x18,0x84,0x60,0x30,0xC0,0x0C,0x08,0x00,0x00,0x02  ,
 0x01,0x7F,0x02,0x04,0x03,0x7E,0x42,0x42,0x42,0x7F,0x01,0x00  ,/*"裕",15*/
/* (14 X 16 , 宋体 )*/

 0x00,0x40,0xC4,0xCC,0x20,0x84,0xC4,0xA4,0x94,0x8C,0x84,0x80,0x80,0x00,0x00,0x00  ,
 0x7C,0x03,0x10,0x48,0x26,0x11,0x08,0x47,0x40,0x7E,0x01,0x00  ,/*"汤",16*/
/* (14 X 16 , 宋体 )*/

 0x00,0x10,0x1C,0x28,0xA8,0x68,0xAA,0x2C,0x28,0x28,0xE8,0x18,0x08,0x00,0x00,0x42  ,
 0x4A,0x29,0x24,0x12,0x49,0x6F,0x13,0x05,0x18,0x10,0x00,0x00  ,/*"家",17*/
/* (14 X 16 , 宋体 )*/

 0x00,0x08,0x08,0x88,0xE8,0x58,0x4E,0x48,0x48,0x48,0xC8,0x08,0x08,0x00,0x00,0x02  ,
 0x01,0x00,0x7F,0x0A,0x0A,0x0A,0x4A,0xCA,0x7F,0x00,0x00,0x00  ,/*"有",18*/
/* (14 X 16 , 宋体 )*/
...
const byte F14x16AA[]=
{
0x00,0x80,0xE0,0xFC,0x9E,0x0A,0x48,0x48,0x4E,0x4E,0x48,0x68,0x28,0x08,0x00,0x00,
0x00,0x7F,0x7F,0x00,0x7D,0x7D,0x25,0x25,0x25,0x7D,0x7D,0x00,/*"信",0*/

0x00,0x00,0x08,0x08,0x08,0x08,0xF8,0xF8,0x08,0x08,0x08,0x0C,0x0C,0x08,0x00,0x00,
0x20,0x20,0x20,0x20,0x3F,0x3F,0x20,0x20,0x20,0x20,0x20,0x20,/*"工",1*/

0x00,0x30,0x3C,0xAE,0xFE,0x7C,0xE4,0xA4,0xFC,0xFC,0x84,0xFC,0x78,0x00,0x00,0x02,
0x02,0x03,0x7F,0x7E,0x4B,0x4B,0x4B,0x4B,0x7E,0x7E,0x00,0x00,/*"智",2*/

0x00,0x30,0xF8,0xFC,0x56,0xDA,0xF8,0x30,0x7E,0xFE,0x98,0x88,0xF8,0x70,0x00,0x00,
0x7F,0x7F,0x49,0x7F,0x7F,0x00,0x7E,0x7E,0x4C,0x46,0x72,0x70,/*"能",3*/

0x00,0x00,0x08,0xC8,0xF8,0x3C,0x0E,0xEA,0xE8,0x08,0x88,0x88,0x08,0x00,0x00,0x08,
0x08,0x09,0x09,0x09,0x09,0x7F,0x7F,0x09,0x09,0x08,0x08,0x08,/*"车",4*/
...
void LED_WrCmd(uint8_t cmd) //写命令函数
{
	uint8_t i = 8;
	//LED_CS = 0;
	LED_DCL;;;
...
//返回：无
//==============================================================
/*void LED_PrintValueC(uint8_t x, uint8_t y, S8 data)
{
...
void LED_PrintImage(uchar *puc, uchar RowNum, uchar ColumnNum)
{
   ...
   LED_Set_Pos(12,(uchar)i); //设置剩下的行显示的起始坐标
    RowTmp = i << 3;       //计算当前所在行的下标
    for(j = 0; j < ColumnNum; j++) //列扫描
    {
        Data = 0;
...
/*******************************************************************************
* Function Name  :void LCD_ShowSTD(void)
* Description    :桌面显示
* Input          : None
* Output         : None
* Return         : None
* Attention		 : None
*******************************************************************************/
extern uint16_t ADD_B;
extern uint16_t ADC_FroBack_6[6];
extern uint16_t GivingAngle;
...
/*void DM_LCD_ShowSTD(void)
{
    ...
    DM_LCD_ShowIntS (1,ADC_FroBack_6[1]);
    DM_LCD_ShowIntS (2,ADC_FroBack_6[3]);
    DM_LCD_ShowIntS (3,ADC_FroBack_6[5]);

    LED_PrintValueI(0,1,ADC_FroBack_6[0]);
    LED_PrintValueI(0,2,ADC_FroBack_6[2]);
    LED_PrintValueI(0,3,ADC_FroBack_6[4]);
   // DM_LCD_ShowIntS (4,ADC_FroBack_6[3]);
 // LED_PrintValueF(0,4,key_mid,3);
   LED_PrintValueI(0,4,key1);
   LED_PrintValueI(60,4,key2);
   // DM_LCD_ShowIntS (5, stop_num);
   LED_PrintValueI(0,5,key3);
   LED_PrintValueI(60,5,key4);
    DM_LCD_ShowIntS (6,  miao);
    LED_PrintValueI(0,6,key_flage);
    DM_LCD_ShowIntS (7, kk);
    //DM_LCD_ShowIntS (7, i0);
}*/
/*******************************************************************************
* Function Name  :void LCD_ShowInt(uint16_t row,uint16_t num)
* Description    :显示数字（在指定位置）
* Input          : None
* Output         : None
* Return         : None
* Attention		 : None
...
{
  LED_PrintValueI(65,row,num);
}


void prif_oled_init(void)
{
   // LED_P6x8Str(0,1,"0:");
   // LED_P6x8Str(0,2,"1:");
   // LED_P6x8Str(0,3,"ADCF2:");
   // LED_P6x8Str(0,4,"ADCF3:");

    LED_P6x8Str(0,5,"angle");
   // LED_P6x8Str(0,6,"keyflage");
    LED_P6x8Str(0,7,"kk:");
}
